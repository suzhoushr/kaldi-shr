...
dir=exp_chw/our_cld_small_model_85
[ -d $dir ] && rm -rf $dir
mkdir -p $dir
if [ $stage -le 0 ]; then
  echo =====================================================================
...
if [ $stage -le 1 ]; then
  ...
  $cuda_cmd $dir/log/train_ctc.log \
    shr_scripts/chw/utils/train_ctc_parallel.sh --add-deltas false --norm-vars false --num-sequence 50 --valid-num-sequence 100 \
      ...
      --nnet-proto exp_chw/cld_85.proto \
...
#./shr_scripts/chw/utils/img2condata.py ./data_our_chw/val.list "test" | copy-feats ark:- ark,scp:./data_our_chw/test/data.cv.ark.85,./data_our_chw/test/feats.scp.85  ./shr_scripts/chw/utils/img2condata.py ./data_our_chw/train.list "train" | copy-feats ark:- ark,scp:./data_our_chw/train/data.tr.ark.85,./data_our_chw/train/feats.scp.85
