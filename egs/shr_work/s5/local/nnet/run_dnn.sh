...
# dir=exp/ori_dnn_sigmoid_with_dbn_6_layers 
...
if [ $stage -le 2 ]; then
  ...
  $cuda_cmd $dir/log/train_nnet.log \
    steps/nnet/train.sh --feature-transform $feature_transform --dbn $dbn --hid-layers 3 --learn-rate 0.008 \
...
#srcdir=exp/ori_dnn_sigmoid_with_dbn_6_layers
acwt=0.2
